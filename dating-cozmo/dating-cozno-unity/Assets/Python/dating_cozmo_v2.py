...
class DatingCozmo:
    ...
    async def throw_cube_anim(self):
        await self.coz.play_anim("anim_freeplay_reacttoface_disagree_01", loop_count=1).wait_for_completed()
        await self.drive(45)
    ...
    async def escalating_relationship_scene(self):
        ...
        await self.coz.play_anim("anim_reacttoblock_ask2ndblock_01_45", loop_count=1).wait_for_completed()
        ...
        if (int(self.answer) == 1):
            ...
            await self.wait_for_answer(["id_rollblock_fail_01", "anim_reacttoblock_failtoroll_01", "anim_reacttoblock_failtodock_01"])
            ...
            await self.wait_for_answer()
            await self.ask_question(32, ["anim_freeplay_reacttoface_squint_22.5"])
            await self.wait_for_answer(["id_rollblock_fail_01","anim_reacttoblock_failtoroll_01","anim_reacttoblock_failtodock_01"])
    ...
    async def photo_seq_scene(self):
        ...
        await self.ask_question(15, ["anim_reacttoblock_failtoroll_01", "anim_reacttoblock_failtodock_01",
